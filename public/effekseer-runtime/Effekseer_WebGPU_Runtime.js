...
var ASM_CONSTS = {
  188858: ($0, $1, $2, $3) => { var buffer = Module._loadBinary(Module.UTF16ToString($0), $3); if (!buffer) { return; } var bytes = new Uint8Array(buffer); var memptr = _malloc(bytes.byteLength); HEAP8.set(bytes, memptr); setValue($1, memptr, "i32"); setValue($2, bytes.byteLength, "i32"); }
};
