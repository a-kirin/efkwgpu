...
// include: C:/Users/max/Music/eff1/LATEST/46/effekser/_staging_webgpu_copy/Effekseer/Examples/WebGPU/pre_webgpu.js
// Pre-initialize WebGPU device for emdawnwebgpu before C/C++ main starts.
...
Module.preRun.push(function () {
  ...
  (async function () {
    ...
    Module.preinitializedWebGPUDevice = await adapter.requestDevice(
      requiredFeatures.length > 0 ? { requiredFeatures: requiredFeatures } : {}
    );
...
// end include: C:/Users/max/Music/eff1/LATEST/46/effekser/_staging_webgpu_copy/Effekseer/Examples/WebGPU/pre_webgpu.js
...
function findWasmBinary() {
  return locateFile('Effekseer_WebGPU_Runtime.wasm');
}
...
var ASM_CONSTS = {
  189098: ($0) => { console.warn(UTF8ToString($0)); },  
 189134: ($0, $1, $2, $3) => { var buffer = Module._loadBinary(Module.UTF16ToString($0), $3); if (!buffer) { return; } var bytes = new Uint8Array(buffer); var memptr = _malloc(bytes.byteLength); HEAP8.set(bytes, memptr); setValue($1, memptr, "i32"); setValue($2, bytes.byteLength, "i32"); }
};
function EfkImportExternalRenderPassEncoder() { if (typeof Module === "undefined" || !Module.__effekseerExternalRenderPass) { return 0; } if (typeof WebGPU === "undefined" || !WebGPU.importJsRenderPassEncoder) { return 0; } return WebGPU.importJsRenderPassEncoder(Module.__effekseerExternalRenderPass, 0); }
function EfkImportDepthTextureView() { if (typeof Module === "undefined" || !Module.__effekseerDepthTextureView) { return 0; } if (typeof WebGPU === "undefined" || !WebGPU.importJsTextureView) { return 0; } return WebGPU.importJsTextureView(Module.__effekseerDepthTextureView, 0); }
function EfkImportBackgroundTextureView() { if (typeof Module === "undefined" || !Module.__effekseerBackgroundTextureView) { return 0; } if (typeof WebGPU === "undefined" || !WebGPU.importJsTextureView) { return 0; } return WebGPU.importJsTextureView(Module.__effekseerBackgroundTextureView, 0); }
function EfkImportExternalPassColorFormatRaw() { if (typeof Module === "undefined") { return -1; } const value = Module.__effekseerExternalPassColorFormat; if (value === undefined || value === null) { return -1; } return value | 0; }
function EfkImportExternalPassDepthFormatRaw() { if (typeof Module === "undefined") { return -1; } const value = Module.__effekseerExternalPassDepthFormat; if (value === undefined || value === null) { return -1; } return value | 0; }
function EfkImportExternalPassSampleCountRaw() { if (typeof Module === "undefined") { return -1; } const value = Module.__effekseerExternalPassSampleCount; if (value === undefined || value === null) { return -1; } return value | 0; }
function EfkSupportsCommandEncoderTimestampOps() { if (typeof GPUCommandEncoder === "undefined" || !GPUCommandEncoder.prototype) { return 0; } const proto = GPUCommandEncoder.prototype; return (typeof proto.writeTimestamp === "function" && typeof proto.resolveQuerySet === "function") ? 1 : 0; }

// Imports from the Wasm binary.
var _EffekseerInitInternal,
  _EffekseerInitExternal,
  _EffekseerInit,
  _EffekseerTerminate,
  _EffekseerUpdate,
  ...
  _EffekseerDraw,
  _EffekseerDrawExternal,
  _EffekseerDrawExternalBack,
  _EffekseerDrawExternalFront,
  _EffekseerBeginDraw,
  _EffekseerEndDraw,
  _EffekseerDrawHandle,
  ...
  _EffekseerLoadEfkWgpuPackage,
  _EffekseerUnloadEfkWgpuPackage,
  _EffekseerIsEfkWgpuPackageLoaded,
  _EffekseerGetEfkWgpuMainEffectPathLength,
  _EffekseerGetEfkWgpuMainEffectPath,
  _EffekseerGetEfkWgpuPackageGlobalFlags,
  _EffekseerLoadEffect,
  _EffekseerLoadEffectFromPackage,
  _EffekseerReleaseEffect,
  _EffekseerReloadResources,
  _EffekseerStopAllEffects,
  _EffekseerPlayEffect,
  _EffekseerStopEffect,
  _EffekseerStopRoot,
  _EffekseerExists,
  _EffekseerSetFrame,
  ...
  _EffekseerSetCompositeMode,
  _EffekseerGetRestInstancesCount,
  _EffekseerGetUpdateTime,
  _EffekseerGetDrawTime,
  _EffekseerGetDrawFlushComputeTime,
  _EffekseerGetDrawBeginFrameTime,
  _EffekseerGetDrawManagerTime,
  _EffekseerGetDrawEndFrameTime,
  _EffekseerGetDrawTotalTime,
  _EffekseerGetGpuTimestampSupported,
  _EffekseerGetGpuTimestampValid,
  _EffekseerGetGpuTimestampEffekseerPassTime,
  _EffekseerGetGpuTimestampFrameTime,
  _EffekseerGetGpuTimestampReadPending,
  _EffekseerGetGpuTimestampLastMapStatus,
  _EffekseerGetGpuTimestampMapState,
  _EffekseerGetGpuTimestampMapMode,
  _EffekseerGetGpuTimestampStallRecoveries,
  _EffekseerGetRendererProfileBindGroupTime,
  _EffekseerGetRendererProfileBindGroupCacheFlushCount,
  _EffekseerGetRendererProfileBindGroupCacheHits,
  _EffekseerGetRendererProfileBindGroupCacheMisses,
  _EffekseerGetRendererProfileBindGroupCreates,
  _EffekseerGetRendererProfilePipelineTime,
  _EffekseerGetRendererProfileSetStateTime,
  _EffekseerGetRendererProfileIssueDrawTime,
  _EffekseerGetRendererProfileDrawTotalTime,
  _EffekseerGetRendererProfileDrawSpritesCalls,
  _EffekseerGetRendererProfileDrawPolygonCalls,
  _EffekseerGetInternalStandardRendererTextureSetupTime,
  _EffekseerGetInternalStandardRendererShaderSelectTime,
  _EffekseerGetInternalStandardRendererVertexPackTime,
  _EffekseerGetInternalStandardRendererPixelPackTime,
  _EffekseerGetInternalStandardRendererConstantUploadTime,
  _EffekseerGetInternalStandardRendererRenderStateTime,
  _EffekseerGetInternalStandardRendererVertexBindTime,
  _EffekseerGetInternalStandardRendererIndexBindTime,
  _EffekseerGetInternalStandardRendererLayoutTime,
  _EffekseerGetInternalStandardRendererDrawTime,
  _EffekseerGetManagerProfileFrustumTime,
  _EffekseerGetManagerProfileSortTime,
  _EffekseerGetManagerProfileCanDrawTime,
  _EffekseerGetManagerProfileContainerDrawTime,
  _EffekseerGetManagerProfileGpuParticleTime,
  _EffekseerGetManagerProfileDrawSetCount,
  _EffekseerGetManagerProfileVisibleDrawSetCount,
  _EffekseerGetManagerProfileContainersTotal,
  _EffekseerGetManagerProfileContainersDrawn,
  _EffekseerGetManagerProfileContainersDepthCulled,
  _EffekseerGetDrawCallCount,
  _EffekseerGetDrawVertexCount,
  _EffekseerGetTotalParticleCount,
  ...
  _EffekseerSetDepthTexture,
  _EffekseerSetBackgroundTexture,
  _wgpuDeviceAddRef,
  _free,
  _malloc,
...
function assignWasmExports(wasmExports) {
  _EffekseerInitInternal = Module['_EffekseerInitInternal'] = wasmExports['EffekseerInitInternal'];
  _EffekseerInitExternal = Module['_EffekseerInitExternal'] = wasmExports['EffekseerInitExternal'];
  _EffekseerInit = Module['_EffekseerInit'] = wasmExports['EffekseerInit'];
  _EffekseerTerminate = Module['_EffekseerTerminate'] = wasmExports['EffekseerTerminate'];
  _EffekseerUpdate = Module['_EffekseerUpdate'] = wasmExports['EffekseerUpdate'];
  _EffekseerBeginUpdate = Module['_EffekseerBeginUpdate'] = wasmExports['EffekseerBeginUpdate'];
  _EffekseerEndUpdate = Module['_EffekseerEndUpdate'] = wasmExports['EffekseerEndUpdate'];
  _EffekseerUpdateHandle = Module['_EffekseerUpdateHandle'] = wasmExports['EffekseerUpdateHandle'];
  _EffekseerDraw = Module['_EffekseerDraw'] = wasmExports['EffekseerDraw'];
  _EffekseerDrawExternal = Module['_EffekseerDrawExternal'] = wasmExports['EffekseerDrawExternal'];
  _EffekseerDrawExternalBack = Module['_EffekseerDrawExternalBack'] = wasmExports['EffekseerDrawExternalBack'];
  _EffekseerDrawExternalFront = Module['_EffekseerDrawExternalFront'] = wasmExports['EffekseerDrawExternalFront'];
  _EffekseerBeginDraw = Module['_EffekseerBeginDraw'] = wasmExports['EffekseerBeginDraw'];
  _EffekseerEndDraw = Module['_EffekseerEndDraw'] = wasmExports['EffekseerEndDraw'];
  _EffekseerDrawHandle = Module['_EffekseerDrawHandle'] = wasmExports['EffekseerDrawHandle'];
  _EffekseerSetProjectionMatrix = Module['_EffekseerSetProjectionMatrix'] = wasmExports['EffekseerSetProjectionMatrix'];
  _EffekseerSetProjectionPerspective = Module['_EffekseerSetProjectionPerspective'] = wasmExports['EffekseerSetProjectionPerspective'];
  _EffekseerSetProjectionOrthographic = Module['_EffekseerSetProjectionOrthographic'] = wasmExports['EffekseerSetProjectionOrthographic'];
  _EffekseerSetCameraMatrix = Module['_EffekseerSetCameraMatrix'] = wasmExports['EffekseerSetCameraMatrix'];
  _EffekseerSetCameraLookAt = Module['_EffekseerSetCameraLookAt'] = wasmExports['EffekseerSetCameraLookAt'];
  _EffekseerLoadEfkWgpuPackage = Module['_EffekseerLoadEfkWgpuPackage'] = wasmExports['EffekseerLoadEfkWgpuPackage'];
  _EffekseerUnloadEfkWgpuPackage = Module['_EffekseerUnloadEfkWgpuPackage'] = wasmExports['EffekseerUnloadEfkWgpuPackage'];
  _EffekseerIsEfkWgpuPackageLoaded = Module['_EffekseerIsEfkWgpuPackageLoaded'] = wasmExports['EffekseerIsEfkWgpuPackageLoaded'];
  _EffekseerGetEfkWgpuMainEffectPathLength = Module['_EffekseerGetEfkWgpuMainEffectPathLength'] = wasmExports['EffekseerGetEfkWgpuMainEffectPathLength'];
  _EffekseerGetEfkWgpuMainEffectPath = Module['_EffekseerGetEfkWgpuMainEffectPath'] = wasmExports['EffekseerGetEfkWgpuMainEffectPath'];
  _EffekseerGetEfkWgpuPackageGlobalFlags = Module['_EffekseerGetEfkWgpuPackageGlobalFlags'] = wasmExports['EffekseerGetEfkWgpuPackageGlobalFlags'];
  _EffekseerLoadEffect = Module['_EffekseerLoadEffect'] = wasmExports['EffekseerLoadEffect'];
  _EffekseerLoadEffectFromPackage = Module['_EffekseerLoadEffectFromPackage'] = wasmExports['EffekseerLoadEffectFromPackage'];
  _EffekseerReleaseEffect = Module['_EffekseerReleaseEffect'] = wasmExports['EffekseerReleaseEffect'];
  _EffekseerReloadResources = Module['_EffekseerReloadResources'] = wasmExports['EffekseerReloadResources'];
  _EffekseerStopAllEffects = Module['_EffekseerStopAllEffects'] = wasmExports['EffekseerStopAllEffects'];
  _EffekseerPlayEffect = Module['_EffekseerPlayEffect'] = wasmExports['EffekseerPlayEffect'];
  _EffekseerStopEffect = Module['_EffekseerStopEffect'] = wasmExports['EffekseerStopEffect'];
  _EffekseerStopRoot = Module['_EffekseerStopRoot'] = wasmExports['EffekseerStopRoot'];
  _EffekseerExists = Module['_EffekseerExists'] = wasmExports['EffekseerExists'];
  _EffekseerSetFrame = Module['_EffekseerSetFrame'] = wasmExports['EffekseerSetFrame'];
  _EffekseerSetLocation = Module['_EffekseerSetLocation'] = wasmExports['EffekseerSetLocation'];
  _EffekseerSetRotation = Module['_EffekseerSetRotation'] = wasmExports['EffekseerSetRotation'];
  _EffekseerSetScale = Module['_EffekseerSetScale'] = wasmExports['EffekseerSetScale'];
  _EffekseerSetMatrix = Module['_EffekseerSetMatrix'] = wasmExports['EffekseerSetMatrix'];
  _EffekseerSetAllColor = Module['_EffekseerSetAllColor'] = wasmExports['EffekseerSetAllColor'];
  _EffekseerSetTargetLocation = Module['_EffekseerSetTargetLocation'] = wasmExports['EffekseerSetTargetLocation'];
  _EffekseerGetDynamicInput = Module['_EffekseerGetDynamicInput'] = wasmExports['EffekseerGetDynamicInput'];
  _EffekseerSetDynamicInput = Module['_EffekseerSetDynamicInput'] = wasmExports['EffekseerSetDynamicInput'];
  _EffekseerSendTrigger = Module['_EffekseerSendTrigger'] = wasmExports['EffekseerSendTrigger'];
  _EffekseerSetPaused = Module['_EffekseerSetPaused'] = wasmExports['EffekseerSetPaused'];
  _EffekseerSetShown = Module['_EffekseerSetShown'] = wasmExports['EffekseerSetShown'];
  _EffekseerSetSpeed = Module['_EffekseerSetSpeed'] = wasmExports['EffekseerSetSpeed'];
  _EffekseerSetRandomSeed = Module['_EffekseerSetRandomSeed'] = wasmExports['EffekseerSetRandomSeed'];
  _EffekseerSetCompositeMode = Module['_EffekseerSetCompositeMode'] = wasmExports['EffekseerSetCompositeMode'];
  _EffekseerGetRestInstancesCount = Module['_EffekseerGetRestInstancesCount'] = wasmExports['EffekseerGetRestInstancesCount'];
  _EffekseerGetUpdateTime = Module['_EffekseerGetUpdateTime'] = wasmExports['EffekseerGetUpdateTime'];
  _EffekseerGetDrawTime = Module['_EffekseerGetDrawTime'] = wasmExports['EffekseerGetDrawTime'];
  _EffekseerGetDrawFlushComputeTime = Module['_EffekseerGetDrawFlushComputeTime'] = wasmExports['EffekseerGetDrawFlushComputeTime'];
  _EffekseerGetDrawBeginFrameTime = Module['_EffekseerGetDrawBeginFrameTime'] = wasmExports['EffekseerGetDrawBeginFrameTime'];
  _EffekseerGetDrawManagerTime = Module['_EffekseerGetDrawManagerTime'] = wasmExports['EffekseerGetDrawManagerTime'];
  _EffekseerGetDrawEndFrameTime = Module['_EffekseerGetDrawEndFrameTime'] = wasmExports['EffekseerGetDrawEndFrameTime'];
  _EffekseerGetDrawTotalTime = Module['_EffekseerGetDrawTotalTime'] = wasmExports['EffekseerGetDrawTotalTime'];
  _EffekseerGetGpuTimestampSupported = Module['_EffekseerGetGpuTimestampSupported'] = wasmExports['EffekseerGetGpuTimestampSupported'];
  _EffekseerGetGpuTimestampValid = Module['_EffekseerGetGpuTimestampValid'] = wasmExports['EffekseerGetGpuTimestampValid'];
  _EffekseerGetGpuTimestampEffekseerPassTime = Module['_EffekseerGetGpuTimestampEffekseerPassTime'] = wasmExports['EffekseerGetGpuTimestampEffekseerPassTime'];
  _EffekseerGetGpuTimestampFrameTime = Module['_EffekseerGetGpuTimestampFrameTime'] = wasmExports['EffekseerGetGpuTimestampFrameTime'];
  _EffekseerGetGpuTimestampReadPending = Module['_EffekseerGetGpuTimestampReadPending'] = wasmExports['EffekseerGetGpuTimestampReadPending'];
  _EffekseerGetGpuTimestampLastMapStatus = Module['_EffekseerGetGpuTimestampLastMapStatus'] = wasmExports['EffekseerGetGpuTimestampLastMapStatus'];
  _EffekseerGetGpuTimestampMapState = Module['_EffekseerGetGpuTimestampMapState'] = wasmExports['EffekseerGetGpuTimestampMapState'];
  _EffekseerGetGpuTimestampMapMode = Module['_EffekseerGetGpuTimestampMapMode'] = wasmExports['EffekseerGetGpuTimestampMapMode'];
  _EffekseerGetGpuTimestampStallRecoveries = Module['_EffekseerGetGpuTimestampStallRecoveries'] = wasmExports['EffekseerGetGpuTimestampStallRecoveries'];
  _EffekseerGetRendererProfileBindGroupTime = Module['_EffekseerGetRendererProfileBindGroupTime'] = wasmExports['EffekseerGetRendererProfileBindGroupTime'];
  _EffekseerGetRendererProfileBindGroupCacheFlushCount = Module['_EffekseerGetRendererProfileBindGroupCacheFlushCount'] = wasmExports['EffekseerGetRendererProfileBindGroupCacheFlushCount'];
  _EffekseerGetRendererProfileBindGroupCacheHits = Module['_EffekseerGetRendererProfileBindGroupCacheHits'] = wasmExports['EffekseerGetRendererProfileBindGroupCacheHits'];
  _EffekseerGetRendererProfileBindGroupCacheMisses = Module['_EffekseerGetRendererProfileBindGroupCacheMisses'] = wasmExports['EffekseerGetRendererProfileBindGroupCacheMisses'];
  _EffekseerGetRendererProfileBindGroupCreates = Module['_EffekseerGetRendererProfileBindGroupCreates'] = wasmExports['EffekseerGetRendererProfileBindGroupCreates'];
  _EffekseerGetRendererProfilePipelineTime = Module['_EffekseerGetRendererProfilePipelineTime'] = wasmExports['EffekseerGetRendererProfilePipelineTime'];
  _EffekseerGetRendererProfileSetStateTime = Module['_EffekseerGetRendererProfileSetStateTime'] = wasmExports['EffekseerGetRendererProfileSetStateTime'];
  _EffekseerGetRendererProfileIssueDrawTime = Module['_EffekseerGetRendererProfileIssueDrawTime'] = wasmExports['EffekseerGetRendererProfileIssueDrawTime'];
  _EffekseerGetRendererProfileDrawTotalTime = Module['_EffekseerGetRendererProfileDrawTotalTime'] = wasmExports['EffekseerGetRendererProfileDrawTotalTime'];
  _EffekseerGetRendererProfileDrawSpritesCalls = Module['_EffekseerGetRendererProfileDrawSpritesCalls'] = wasmExports['EffekseerGetRendererProfileDrawSpritesCalls'];
  _EffekseerGetRendererProfileDrawPolygonCalls = Module['_EffekseerGetRendererProfileDrawPolygonCalls'] = wasmExports['EffekseerGetRendererProfileDrawPolygonCalls'];
  _EffekseerGetInternalStandardRendererTextureSetupTime = Module['_EffekseerGetInternalStandardRendererTextureSetupTime'] = wasmExports['EffekseerGetInternalStandardRendererTextureSetupTime'];
  _EffekseerGetInternalStandardRendererShaderSelectTime = Module['_EffekseerGetInternalStandardRendererShaderSelectTime'] = wasmExports['EffekseerGetInternalStandardRendererShaderSelectTime'];
  _EffekseerGetInternalStandardRendererVertexPackTime = Module['_EffekseerGetInternalStandardRendererVertexPackTime'] = wasmExports['EffekseerGetInternalStandardRendererVertexPackTime'];
  _EffekseerGetInternalStandardRendererPixelPackTime = Module['_EffekseerGetInternalStandardRendererPixelPackTime'] = wasmExports['EffekseerGetInternalStandardRendererPixelPackTime'];
  _EffekseerGetInternalStandardRendererConstantUploadTime = Module['_EffekseerGetInternalStandardRendererConstantUploadTime'] = wasmExports['EffekseerGetInternalStandardRendererConstantUploadTime'];
  _EffekseerGetInternalStandardRendererRenderStateTime = Module['_EffekseerGetInternalStandardRendererRenderStateTime'] = wasmExports['EffekseerGetInternalStandardRendererRenderStateTime'];
  _EffekseerGetInternalStandardRendererVertexBindTime = Module['_EffekseerGetInternalStandardRendererVertexBindTime'] = wasmExports['EffekseerGetInternalStandardRendererVertexBindTime'];
  _EffekseerGetInternalStandardRendererIndexBindTime = Module['_EffekseerGetInternalStandardRendererIndexBindTime'] = wasmExports['EffekseerGetInternalStandardRendererIndexBindTime'];
  _EffekseerGetInternalStandardRendererLayoutTime = Module['_EffekseerGetInternalStandardRendererLayoutTime'] = wasmExports['EffekseerGetInternalStandardRendererLayoutTime'];
  _EffekseerGetInternalStandardRendererDrawTime = Module['_EffekseerGetInternalStandardRendererDrawTime'] = wasmExports['EffekseerGetInternalStandardRendererDrawTime'];
  _EffekseerGetManagerProfileFrustumTime = Module['_EffekseerGetManagerProfileFrustumTime'] = wasmExports['EffekseerGetManagerProfileFrustumTime'];
  _EffekseerGetManagerProfileSortTime = Module['_EffekseerGetManagerProfileSortTime'] = wasmExports['EffekseerGetManagerProfileSortTime'];
  _EffekseerGetManagerProfileCanDrawTime = Module['_EffekseerGetManagerProfileCanDrawTime'] = wasmExports['EffekseerGetManagerProfileCanDrawTime'];
  _EffekseerGetManagerProfileContainerDrawTime = Module['_EffekseerGetManagerProfileContainerDrawTime'] = wasmExports['EffekseerGetManagerProfileContainerDrawTime'];
  _EffekseerGetManagerProfileGpuParticleTime = Module['_EffekseerGetManagerProfileGpuParticleTime'] = wasmExports['EffekseerGetManagerProfileGpuParticleTime'];
  _EffekseerGetManagerProfileDrawSetCount = Module['_EffekseerGetManagerProfileDrawSetCount'] = wasmExports['EffekseerGetManagerProfileDrawSetCount'];
  _EffekseerGetManagerProfileVisibleDrawSetCount = Module['_EffekseerGetManagerProfileVisibleDrawSetCount'] = wasmExports['EffekseerGetManagerProfileVisibleDrawSetCount'];
  _EffekseerGetManagerProfileContainersTotal = Module['_EffekseerGetManagerProfileContainersTotal'] = wasmExports['EffekseerGetManagerProfileContainersTotal'];
  _EffekseerGetManagerProfileContainersDrawn = Module['_EffekseerGetManagerProfileContainersDrawn'] = wasmExports['EffekseerGetManagerProfileContainersDrawn'];
  _EffekseerGetManagerProfileContainersDepthCulled = Module['_EffekseerGetManagerProfileContainersDepthCulled'] = wasmExports['EffekseerGetManagerProfileContainersDepthCulled'];
  _EffekseerGetDrawCallCount = Module['_EffekseerGetDrawCallCount'] = wasmExports['EffekseerGetDrawCallCount'];
  _EffekseerGetDrawVertexCount = Module['_EffekseerGetDrawVertexCount'] = wasmExports['EffekseerGetDrawVertexCount'];
  _EffekseerGetTotalParticleCount = Module['_EffekseerGetTotalParticleCount'] = wasmExports['EffekseerGetTotalParticleCount'];
  _EffekseerIsVertexArrayObjectSupported = Module['_EffekseerIsVertexArrayObjectSupported'] = wasmExports['EffekseerIsVertexArrayObjectSupported'];
  _EffekseerSetRestorationOfStatesFlag = Module['_EffekseerSetRestorationOfStatesFlag'] = wasmExports['EffekseerSetRestorationOfStatesFlag'];
  _EffekseerCaptureBackground = Module['_EffekseerCaptureBackground'] = wasmExports['EffekseerCaptureBackground'];
  _EffekseerResetBackground = Module['_EffekseerResetBackground'] = wasmExports['EffekseerResetBackground'];
  _EffekseerSetLogEnabled = Module['_EffekseerSetLogEnabled'] = wasmExports['EffekseerSetLogEnabled'];
  _EffekseerSetDepthTexture = Module['_EffekseerSetDepthTexture'] = wasmExports['EffekseerSetDepthTexture'];
  _EffekseerSetBackgroundTexture = Module['_EffekseerSetBackgroundTexture'] = wasmExports['EffekseerSetBackgroundTexture'];
...
var wasmImports = {
  /** @export */
  EfkImportBackgroundTextureView,
  /** @export */
  EfkImportDepthTextureView,
  /** @export */
  EfkImportExternalPassColorFormatRaw,
  /** @export */
  EfkImportExternalPassDepthFormatRaw,
  /** @export */
  EfkImportExternalPassSampleCountRaw,
  /** @export */
  EfkImportExternalRenderPassEncoder,
  /** @export */
  EfkSupportsCommandEncoderTimestampOps,
  /** @export */
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = effekseer_webgpu_native;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = effekseer_webgpu_native;
} else if (typeof define === 'function' && define['amd'])
  define([], () => effekseer_webgpu_native);
